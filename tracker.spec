...
Version  : 2.1.7
Release  : 20
URL      : https://download.gnome.org/sources/tracker/2.1/tracker-2.1.7.tar.xz
Source0  : https://download.gnome.org/sources/tracker/2.1/tracker-2.1.7.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1550192579
...
/usr/lib64/libtracker-control-2.0.so.0.107.0
/usr/lib64/libtracker-miner-2.0.so.0
/usr/lib64/libtracker-miner-2.0.so.0.107.0
/usr/lib64/libtracker-sparql-2.0.so.0
/usr/lib64/libtracker-sparql-2.0.so.0.107.0
