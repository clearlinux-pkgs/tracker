...
Version  : 3.7.1
Release  : 59
URL      : https://download.gnome.org/sources/tracker/3.7/tracker-3.7.1.tar.xz
Source0  : https://download.gnome.org/sources/tracker/3.7/tracker-3.7.1.tar.xz
...
%prep
%setup -q -n tracker-3.7.1
cd %{_builddir}/tracker-3.7.1
pushd ..
cp -a tracker-3.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711663660
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libtracker-sparql-3.0.so.0.701.0
...
/usr/lib64/libtracker-sparql-3.0.so.0.701.0
