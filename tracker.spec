...
Source0  : https://download.gnome.org/sources/tracker/3.4/tracker-3.4.2.tar.xz
...
%prep
%setup -q -n tracker-3.4.2
cd %{_builddir}/tracker-3.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670511183
...
/usr/lib64/libtracker-sparql-3.0.so.0.402.0
