...
Source0  : https://download.gnome.org/sources/tracker/3.5/tracker-3.5.0.tar.xz
...
%prep
%setup -q -n tracker-3.5.0
cd %{_builddir}/tracker-3.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679939250
...
/usr/lib64/libtracker-sparql-3.0.so.0.500.0
