...
Source0  : https://download.gnome.org/sources/tracker/3.2/tracker-3.2.1.tar.xz
...
%prep
%setup -q -n tracker-3.2.1
cd %{_builddir}/tracker-3.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635962731
...
cp %{_builddir}/tracker-3.2.1/COPYING.GPL %{buildroot}/usr/share/package-licenses/tracker/33fabce185708a9b17df7a9f37c7ed44eddc7e48
cp %{_builddir}/tracker-3.2.1/COPYING.LGPL %{buildroot}/usr/share/package-licenses/tracker/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/tracker-3.2.1/src/libtracker-common/COPYING.LIB %{buildroot}/usr/share/package-licenses/tracker/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/tracker-3.2.1/src/libtracker-data/COPYING.LIB %{buildroot}/usr/share/package-licenses/tracker/9a1929f4700d2407c70b507b3b2aaf6226a9543c
...
/usr/lib64/libtracker-sparql-3.0.so.0.201.0
