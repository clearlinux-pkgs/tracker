...
Version  : 3.0.3
Release  : 33
URL      : https://download.gnome.org/sources/tracker/3.0/tracker-3.0.3.tar.xz
Source0  : https://download.gnome.org/sources/tracker/3.0/tracker-3.0.3.tar.xz
...
%prep
%setup -q -n tracker-3.0.3
cd %{_builddir}/tracker-3.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611707113
...
cp %{_builddir}/tracker-3.0.3/COPYING.GPL %{buildroot}/usr/share/package-licenses/tracker/33fabce185708a9b17df7a9f37c7ed44eddc7e48
cp %{_builddir}/tracker-3.0.3/COPYING.LGPL %{buildroot}/usr/share/package-licenses/tracker/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/tracker-3.0.3/src/libtracker-common/COPYING.LIB %{buildroot}/usr/share/package-licenses/tracker/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/tracker-3.0.3/src/libtracker-data/COPYING.LIB %{buildroot}/usr/share/package-licenses/tracker/9a1929f4700d2407c70b507b3b2aaf6226a9543c
...
/usr/lib64/libtracker-sparql-3.0.so.0.3.0
