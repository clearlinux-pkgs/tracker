...
Source0  : https://download.gnome.org/sources/tracker/2.3/tracker-2.3.0.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568077395
...
/usr/lib64/libtracker-control-2.0.so.0.300.0
/usr/lib64/libtracker-miner-2.0.so.0
/usr/lib64/libtracker-miner-2.0.so.0.300.0
/usr/lib64/libtracker-sparql-2.0.so.0
/usr/lib64/libtracker-sparql-2.0.so.0.300.0
