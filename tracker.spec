...
Source0  : https://download.gnome.org/sources/tracker/3.3/tracker-3.3.0.tar.xz
...
%prep
%setup -q -n tracker-3.3.0
cd %{_builddir}/tracker-3.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647821744
...
cp %{_builddir}/tracker-3.3.0/COPYING.GPL %{buildroot}/usr/share/package-licenses/tracker/33fabce185708a9b17df7a9f37c7ed44eddc7e48
cp %{_builddir}/tracker-3.3.0/COPYING.LGPL %{buildroot}/usr/share/package-licenses/tracker/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/tracker-3.3.0/src/libtracker-common/COPYING.LIB %{buildroot}/usr/share/package-licenses/tracker/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/tracker-3.3.0/src/libtracker-data/COPYING.LIB %{buildroot}/usr/share/package-licenses/tracker/9a1929f4700d2407c70b507b3b2aaf6226a9543c
...
/usr/lib64/libtracker-sparql-3.0.so.0.300.0
