...
Source0  : https://download.gnome.org/sources/tracker/3.4/tracker-3.4.1.tar.xz
...
%prep
%setup -q -n tracker-3.4.1
cd %{_builddir}/tracker-3.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666906691
...
/usr/lib64/libtracker-sparql-3.0.so.0.401.0
