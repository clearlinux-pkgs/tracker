...
Source0  : https://download.gnome.org/sources/tracker/2.2/tracker-2.2.1.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1555013577
...
/usr/lib64/libtracker-control-2.0.so.0.201.0
/usr/lib64/libtracker-miner-2.0.so.0
/usr/lib64/libtracker-miner-2.0.so.0.201.0
/usr/lib64/libtracker-sparql-2.0.so.0
/usr/lib64/libtracker-sparql-2.0.so.0.201.0
