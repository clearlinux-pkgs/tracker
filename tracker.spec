...
Source0  : https://download.gnome.org/sources/tracker/2.1/tracker-2.1.5.tar.xz
...
Requires: tracker-config = %{version}-%{release}
...
export LANG=C
export SOURCE_DATE_EPOCH=1537978228
...
/usr/lib64/libtracker-control-2.0.so.0.105.0
/usr/lib64/libtracker-miner-2.0.so.0
/usr/lib64/libtracker-miner-2.0.so.0.105.0
/usr/lib64/libtracker-sparql-2.0.so.0
/usr/lib64/libtracker-sparql-2.0.so.0.105.0
